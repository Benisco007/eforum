...
class PostModel {
  ...
  factory PostModel.fromFirestore(DocumentSnapshot doc) {
    ...
    return PostModel(
      ...
      likesCount:     (d['likesCount'] as num? ?? 0).toInt().clamp(0, 999999),
      commentsCount:  (d['commentsCount'] as num? ?? 0).toInt().clamp(0, 999999),
      repostsCount:   (d['repostsCount'] as num? ?? 0).toInt().clamp(0, 999999),
